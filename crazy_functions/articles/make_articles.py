...
现在有一篇这个论文的综述，你觉得这个综述是否和我上面给出的提纲具有相关性？以"是否存在可迁移到我的文章的理论或者内容/方法"作为一个判断标准,
...
并且，一定要注意在正文中引用时要带上前三个作者的姓与年份,一般如果作者有三个以上，你可以说“作者A，作者B，作者C（2013）等人做了什么什么,...”。如果作者只有两个，你可以说“作者A与作者B（2013）做了什么什么,...”。如果只有一个人，你可以说“作者A（2013）做了什么什么,...”。
还有，要注意你在正文的引用中一定还要记得在年份后面加入一个占位标签字段，字段格式形如“<作者A 作者B 作者C 2013>”，这些占位标签最后都会被我统一替换为引用的数字角标。例如，如果引用“作者A（2013）做了什么什么，...”，那么你就要在年份后面加入一个占位标签字段，比如“作者A（2013）<作者A 2013>做了什么什么，...”。
同样的，如果你需要同时引用多篇论文，那么你就要在年份后面加入多个占位标签字段，比如“作者A（2013）<作者A 2013>，作者B（2014）<作者B 2014>做了什么什么，...”。
