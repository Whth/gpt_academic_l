...
并且，一定要注意在正文中引用时要带上前三个作者的姓与年份，这里为了便于说明假设了作者1，2，3是虚拟的的作者，注意，正常情况下你需要在引用中使用实际对应的作者名来替换它们,一般如果一篇论文有作者三个以上，你可以说“作者1，作者2，作者3等人（2013）做了什么什么,...”。如果作者只有两个，你可以说“作者1与作者2（2013）做了什么什么,...”。如果只有一个人，你可以说“作者1（2013）做了什么什么,...”。
...
"""
    ...
    def _write_iter_asm_inner(self,grouped:List[Path],written_article_place_holder:str)->str:
        ...
        return (
            ...
            "并且，一定要注意在正文中引用时要带上前三个作者的姓与年份，这里为了便于说明假设了作者1，2，3是虚拟的的作者，注意，正常情况下你需要在引用中使用实际对应的作者名来替换它们,"
