...
额外的，你可以参考参考文献中的图表，如果图表中存在可以迁移到我的文章中的图表来作为对于特定内容的辅助说明，你可以在正文中引用这些图表，不要忘了在引用后面加入占位标签字段。引文直接在正文中使用图或表的名称，比如你要引用作者A，作者B，作者C等人（2016）的论文中的“图-叶片疲劳曲线”，你可以说“作者A，作者B，作者C等人（2016）的图-叶片疲劳曲线所示，表明了什么什么，印证了什么什么，...”。最后我会帮你完成多媒体文件的插入，所以你只需要用字符说明哪里要引用
...
"""
    ...
    def _write_iter_asm_inner(self,grouped:List[Path],written_article_place_holder:str)->str:
        ...
        return (
            ...
            "同样的，如果你需要同时引用多篇论文，那么你就要在年份后面加入多个占位标签字段，比如“作者A（2019），作者B（2024）做了什么什么，...”。\n"
            ...
            "你可以说“如作者A，作者B，作者C等人（2016）的图-叶片疲劳曲线所示，表明了什么什么，印证了什么什么，...”。最后我会帮你完成多媒体文件的插入，所以你只需要用字符说明哪里要引用\n"
